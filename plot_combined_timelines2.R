plot_combined_timelines = function(mdatas, legend=TRUE, plot=TRUE){
  ...
  if(plot){
    ...
    if(legend) legend(1, min_val+2, legend=names_leg,col=c("darkgreen",colors[1:c]), lty=c(1,1:c), cex=0.8)
